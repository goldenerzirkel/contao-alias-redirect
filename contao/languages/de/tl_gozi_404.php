...
$GLOBALS['TL_LANG']['tl_gozi_404']['zielTyp'] = ['Art des Ziels', 'Eine Seite dieser Installation, eine beliebige Adresse (auch auf einem fremden Server) oder gar kein Ziel.'];
